...
app.get("/", function (req, res) {
  res.sendFile(
    "/Users/harkirat/Projects/bootcamp/week-9-notes-app/frontend/index.html",
  );
});

app.get("/signup", function (req, res) {
  res.sendFile(
    "/Users/harkirat/Projects/bootcamp/week-9-notes-app/frontend/signup.html",
  );
});

app.get("/signin", function (req, res) {
  res.sendFile(
    "/Users/harkirat/Projects/bootcamp/week-9-notes-app/frontend/signin.html",
  );
});
